...
const label = localStorage.getItem("codeUpdatedFrom");
if (label !== null && label !== "null") {
  // localStorage can only store strings
  // Reset local storage variable back to null
  localStorage.setItem("codeUpdatedFrom", null);
  monogatari.script({
    Start: [
      function () {
